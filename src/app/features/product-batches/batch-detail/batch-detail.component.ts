...
@Component({
    ...
    template: `
        <app-page-header title="Detalle de lote">
            <a [routerLink]="['/admin/lotes', id, 'editar']" class="btn"
                >Editar</a
            >
        ...
        @if (loading()) {
            ...
            <div class="glass-card">
                <div class="detail-row">
                    <span class="label">ID</span><span>{{ b.id }}</span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <a [routerLink]="['/admin/productos', b.product.id]">{{
                        b.product.name
                    }}</a>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    ><span>{{ b.initial_quantity }}</span>
                </div>
                <div class="detail-row">
                    <span class="label">Cantidad actual</span
                    ><span>{{ b.current_quantity }}</span>
                </div>
                <div class="detail-row">
...
export class BatchDetailComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.service.getById(this.id).subscribe({
            ...
            error: (err) => {
                this.toast.error(
                    extractErrorMessage(err, "No se pudo cargar el lote."),
                );
                this.loading.set(false);
            },
        });
