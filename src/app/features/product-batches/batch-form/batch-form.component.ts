...
@Component({
    ...
    template: `
        <app-page-header
            ...
            [subtitle]="isEdit ? 'Modifica los datos del lote' : 'Registra un nuevo lote'"
        />
            ...
            <form class="glass-card" [formGroup]="form" (ngSubmit)="onSubmit()">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input id="initial_quantity" type="number" formControlName="initial_quantity" min="0" />
                    </div>
                    <div class="form-group">
                        <label for="current_quantity">Cantidad actual *</label>
                        <input id="current_quantity" type="number" formControlName="current_quantity" min="0" />
                    </div>
                </div>
                <div class="form-actions">
                    <a routerLink="/admin/lotes" class="btn btn-secondary">Cancelar</a>
...
export class BatchFormComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        const loads = [
            ...
            ...(this.isEdit && this.editId ? [this.batchService.getById(this.editId)] : []),
        ];
        ...
        forkJoin(loads).subscribe({
            next: (results) => {
                ...
                if (this.isEdit && results[1]) {
                    const b = results[1] as import('../../../core/models/product-batch.model').ProductBatch;
    ...
    onSubmit(): void {
        ...
        op.subscribe({
            next: () => {
                this.toast.success(this.isEdit ? 'Lote actualizado.' : 'Lote creado.');
